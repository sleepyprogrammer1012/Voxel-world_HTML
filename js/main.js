...
// Example function: send block placement
      ...
      // === Basic Setup ===
        ...
        const blockTypes = {
          'grass': { transparent: false, uv: { top: [2, 1], bottom: [1, 2], side: [1, 2] } },
          'dirt': { transparent: false, uv: { all: [1, 2] } },
          'stone': { transparent: false, uv: { all: [0, 0] } },
          'cobblestone': { transparent: false, uv: { all: [0, 1] } },
          'oak_plank': { transparent: false, uv: { all: [1, 2] } },
          'oak_log': { transparent: false, uv: { top: [1, 3], bottom: [1, 3], side: [1, 2] } },
          'sand': { transparent: false, uv: { all: [2, 2] } },
          'gravel': { transparent: false, uv: { all: [1, 1] } },
          'coal_ore': { transparent: false, uv: { all: [2, 0] } },
          'iron_ore': { transparent: false, uv: { all: [3, 2] } },
          'leaves': { transparent: true, uv: { all: [1, 0] } },
