...
// Example function: send block placement
      ...
      // === Basic Setup ===
        ...
        const blockTypes = {
          'grass': { transparent: false, uv: { top: [0, 0], bottom: [1, 0], side: [1, 0] } },
          'dirt': { transparent: false, uv: { all: [1, 0] } },
          'stone': { transparent: false, uv: { all: [2, 0] } },
          'cobblestone': { transparent: false, uv: { all: [3, 0] } },
          'oak_plank': { transparent: false, uv: { all: [2, 1] } },
          'oak_log': { transparent: false, uv: { top: [1, 1], bottom: [1, 1], side: [1, 1] } },
          'sand': { transparent: false, uv: { all: [0, 1] } },
          'gravel': { transparent: false, uv: { all: [3, 1] } },
          'coal_ore': { transparent: false, uv: { all: [0, 2] } },
          'iron_ore': { transparent: false, uv: { all: [1, 2] } },
          'leaves': { transparent: true, uv: { all: [2, 2] } },
          'glass': { transparent: true, uv: { all: [3, 2] } },
          'stone_brick': { transparent: false, uv: { all: [0, 3] } },
          'mossy_stone': { transparent: false, uv: { all: [1, 3] } },
          'bedrock': { transparent: false, uv: { all: [2, 3] } }
        };
